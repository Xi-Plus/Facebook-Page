...
$start=strpos($html,'.E8.8A.82.E5.81.87.E6.97.A5.E5.92.8C.E4.B9.A0.E4.BF.97">節假日和習俗');
$end=strpos($html,'.E5.8F.83.E8.80.83.E8.B3.87.E6.96.99">參考資料');
if($end===false)$html=substr($html, $start);
else $html=substr($html, $start, $end-$start);
$pattern='/節假日和習俗.*?<\/h2><ul>(.*?)<\/ul>/';
